...
<div class="main-box modal-dialog" style="position:absolute;top:15px;">
    ...
    <div class="login-wrap modal-body">
        ...
        <div class="lg_left">
            <div class="lg_lf_top">
                <h2>欢迎加入微博<a href="" title="L(&#39;_ENTER_INDEX_&#39;)"></a>！</h2>
            </div>
            <div class="clearfix"></div>
            <form action="Register.action" method="post" class="lg_lf_form ">
                <div class="form-group new-form">
                    ...
                    <span class="new-icon user-icon"></span>
                        <input type="text" id="inputEmail" class="form-control new-input" placeholder="请输入邮箱" ajaxurl="/member/checkUserNameUnique.html" errormsg="请正确填写邮箱" nullmsg="请填写邮箱" datatype="*4-32" value="" name="person.email" autocomplete="off">
                    <div class="clearfix"></div>
                </div>
                
                <div class="form-group new-form">
                    <label for="inputid" class=".sr-only col-xs-12" style="display: none"></label> 
                    <span class="new-icon user-icon"></span>
                        <input type="text" id="inputid" class="form-control new-input" placeholder="请输入昵称"  errormsg="请填写4-32位用户名" nullmsg="请填写用户名" datatype="*4-32" value="" name="person.username" autocomplete="off">
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group new-form">
                    ...
                    <div id="password_block" class="input-group pull-right" style="width: 100%;">
                        <input type="password" id="inputPassword" class="form-control new-input" placeholder="请输入密码" errormsg="密码为6-20位" nullmsg="请填写密码" datatype="*6-30" name="person.password">
                        <div class="input-group-addon show-password add-show"> <a style="width: 100%;height: 100%" href="javascript:void(0);"><i onclick="change_show(this)"></i></a>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-block btn-primary green-btn">注 册</button>
                </div>
            </form>
...
<link rel="stylesheet" type="text/css" href="./login/sync.css">            </div>
                        <script>
